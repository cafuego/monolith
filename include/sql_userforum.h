...
extern int mono_sql_uf_list_hosts_by_forum(unsigned int );
extern int mono_sql_uf_list_hosts_by_user(unsigned int );
...
extern int mono_sql_uf_list_invited_by_forum(unsigned int );
extern int mono_sql_uf_list_invited_by_user(unsigned int );
...
extern int mono_sql_uf_list_kicked_by_forum(unsigned int );
extern int mono_sql_uf_list_kicked_by_user(unsigned int );
