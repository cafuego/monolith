...
extern int mono_sql_t_updated_highest( unsigned int, unsigned int, unsigned int m_id );
extern int mono_sql_t_get_new_message_id( unsigned int , unsigned int, unsigned int * );
